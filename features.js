...
(function () {
  ...
  function ScreenTools() {
    const items = [
      ...
      ['achievements', '🏅', 'הישגים', 'תגים רגילים ונדירים'],
      ['season', '🏆', 'ליגת המשפחה', 'עונה חודשית + פעילים עכשיו'],
      ['familygoal', '🎯', 'יעד ומתכונים', 'יעד משפחתי משותף + שיתוף מתכונים'],
      ['coachai', '🤖', 'מאמן KIN', 'שאל כל דבר — תשובות לפי הנתונים שלך'],
      ['predict', '🔮', 'חיזוי יעד', 'מתי תגיע ליעד לפי המגמה'],
      ['rehab', '🩹', 'מסלול שיקום', 'חזרה בטוחה מכאב לפי אזור'],
      ['cycle', '🌙', 'מעקב מחזור', 'התאמת אימון לשלב המחזור'],
